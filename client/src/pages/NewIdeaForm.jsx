...
const NewIdeaForm = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.description.length < 100) {
      setError(
        `Description must be at least 100 characters long. You have ${formData.description.length}.`
      );
      return false;
    }
    setError("");
    ...
    <div className="form-page-wrapper">
      ...
      <div className="form-container">
        <div className="form-header">
          ...
          <p>
            {isEditMode
              ? "Refine your concept and resubmit for analysis."
              : "Fill in the details to get an AI-powered analysis."}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-section">
            <div className="form-group">
              <label htmlFor="title">
                Idea Title <span className="required-star">*</span>
              </label>
              <input
                type="text"
                id="title"
                ...
                placeholder="e.g., Eco-friendly Food Delivery App"
                required
              />
            </div>
            ...
            <div className="form-group">
              <label htmlFor="pitch">
                One-Line Pitch <span className="required-star">*</span>
              </label>
              <input
                type="text"
                id="pitch"
                ...
                onChange={handleChange}
                placeholder="e.g., A platform for zero-waste meals from local vendors"
                required
              />
            </div>
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="8"
                placeholder="Describe the problem, your solution, and the target market."
                required
              ></textarea>
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              <label htmlFor="marketSize">Market Size / Demand</label>
              <input
                type="text"
                id="marketSize"
                name="marketSize"
                ...
                onChange={handleChange}
                placeholder="e.g., Estimated $10M market in India"
              />
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="e.g., Swiggy Green, EcoEats UK"
              />
            </div>
