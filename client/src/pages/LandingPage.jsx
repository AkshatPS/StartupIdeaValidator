          ...
          <div className="steps-container">
            <div className="step">
              ...
              <p className="step-description">
                Provide a concise description of your startup concept. The more
                detail, the better the analysis.
              </p>
            </div>
            <div className="step">
              <div className="step-icon">🤖</div>
              ...
              <p className="step-description">
                Our AI runs a comprehensive market analysis, checks competitors,
                and identifies potential strengths and weaknesses.
              </p>
            </div>
            <div className="step">
              <div className="step-icon">📊</div>
              ...
              <p className="step-description">
                Receive a detailed validation report in minutes, complete with
        ...
        <section id="features-section" className="section features-section">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p className="step-description">
                Automatically generate Strengths, Weaknesses, Opportunities, and
                Threats for your business idea.
              </p>
            </div>
            <div className="feature-card">
              <h3 className="feature-title">Competitor Analysis</h3>
              <p className="step-description">
                Identify key competitors in your target market and understand
                their strategies.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p className="step-description">
                Receive creative and strategic suggestions from our AI to refine
                your idea and improve your model.
              </p>
            </div>
          </div>
        </section>
