    ...
    pdf
      .html(reportElement, {
        callback: function (pdf) {
          const filename = `Report-${reportData.title
            .replace(/\s+/g, "-")
            .toLowerCase()}.pdf`;
          pdf.save(filename);
    ...
    const fetchReportData = async () => {
      try {
        ...
        if (
          ...
          setError(
            "Analysis for this idea is not yet complete. Please check back later."
          );
        } else {
        ...
        setError(
          "Could not load the report. The idea may not exist or you may not have permission."
        );
      } finally {
        setIsLoading(false);
      }
      ...
      <div className="report-page-container">
        ...
        <div className="report-sheet" id="report-sheet">
          <header className="report-header">
            <h1>{title}</h1>
            <p>
              Validation Report as of {new Date(createdAt).toLocaleDateString()}
            </p>
          </header>
          ...
          <section className="report-section summary">
            ...
            <p>
              <strong>One-Line Pitch:</strong> {pitch}
            </p>
          ...
          <footer className="report-footer">
            <p>
              This report was generated by Startalyze. It is intended for
              informational purposes and is not a guarantee of success.
            </p>
          </footer>
        </div>
      </div>
