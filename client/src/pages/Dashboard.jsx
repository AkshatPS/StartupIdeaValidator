...
// Mock data for user's ideas - replace with actual data from your backend
const mockIdeas = [
  {
    id: 1,
    title: "AI-Powered Financial Advisor for Millennials",
    submittedOn: "2024-07-20",
    tags: ["FinTech", "AI"],
    score: "High", // Can be 'High', 'Medium', 'Low'
  },
  {
    id: 2,
    title: "Subscription Box for Rare Indoor Plants",
  ...
  {
    id: 3,
    title: "Gamified Language Learning App for Kids",
  ...
  return (
    <div className="idea-card">
      <div className="idea-card-header">
        ...
        <span className={`validation-score score-${idea.score.toLowerCase()}`}>
          {idea.score}
        </span>
      </div>
    ...
    <div className="dashboard-wrapper">
      ...
      <div className="dashboard-container">
        ...
        <main className="main-content">
          ...
          {/* C. Recent Validations (Placeholder) */}
          <section className="recent-validations-section">
            <h2>Recent Activity</h2>
            <p className="placeholder-text">
              Your recent validation history will appear here.
            </p>
          </section>
        </main>
        ...
        <aside className="right-panel">
          ...
          <SidebarPanel title="Featured Ideas">
            <p className="placeholder-text">
              Top-rated community ideas will be shown here.
            </p>
          </SidebarPanel>
